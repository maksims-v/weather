...
async function getData(cityInput) {
    ...
    try {
        ...
        let sunrise = _dateFns.format(new Date(data.sys.sunrise * 1000), 'H:mm');
        let sunset = _dateFns.format(new Date(data.sys.sunset * 1000), 'H:mm');
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kQMTH","adjPd"], "adjPd", "parcelRequire123e")
